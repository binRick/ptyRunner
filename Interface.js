...
app.routeManager.registerRoute('', {
	menu: function (ui) {
		ui
			...
			.option(Conf.Menu[0].Text, function () {
				app.routeManager.openRoute('');
			})
			.option(Conf.Menu[1].Text, function () {
